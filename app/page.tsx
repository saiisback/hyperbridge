    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-4 sm:px-6 py-4 lg:px-12">
        <div className="flex items-center space-x-2 pl-3 sm:pl-6 lg:pl-12">
          <img src="/logo.svg" alt="Winfinitty Logo" className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" />
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="/login" className="text-white/80 hover:text-white transition-colors text-sm lg:text-base font-medium">
          <ShimmerButton className="bg-orange-500 hover:bg-orange-600 text-white px-4 lg:px-6 py-2 rounded-xl text-sm lg:text-base font-medium shadow-lg">
           Login
          </ShimmerButton>
          </a>
      ...
      <main className="relative z-10 flex flex-col items-start justify-start sm:justify-center min-h-[calc(100vh-80px)] px-4 sm:px-6 lg:px-12 max-w-6xl pt-4 sm:-mt-12 lg:-mt-24 pl-6 sm:pl-12 lg:pl-20">
        ...
        <p className="text-white/70 text-sm sm:text-base md:text-sm lg:text-2xl mb-6 sm:mb-8 max-w-2xl text-pretty">
          Join and invest Money
          <br className="hidden sm:block" />
          <span className="sm:hidden"> </span>
          Sharing Breathtaking Profits.
        </p>
